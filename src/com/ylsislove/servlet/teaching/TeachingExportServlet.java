...
public class TeachingExportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("admin".equals(role)) {
            List<Map<String, Object>> allProject = tService.selectTeachingList(type);
            ...
            List<Map<String, Object>> allProject = tService.selectTeachingListByUserId(user.getUserId(), type);
            Map<String, Object> data = new HashMap<>();
            data.put("code", 0);
            data.put("msg", "");
