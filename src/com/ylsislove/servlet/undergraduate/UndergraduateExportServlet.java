...
public class UndergraduateExportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("admin".equals(role)) {
            List<Map<String, Object>> allProject = unService.selectUndergraduateList(type);
            ...
            List<Map<String, Object>> allProject = unService.selectUndergraduateListByUserId(user.getUserId(), type);
            Map<String, Object> data = new HashMap<>();
            data.put("code", 0);
            data.put("msg", "");
