 ...
 */
@WebServlet(value = "/patentEditShow.action")
public class PatentEditShowServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/research/patent-edit.jsp").forward(request, response);
