    ...
    <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header"><b>批量添加一批专利</b></div>
                <div class="layui-card-body">
                    注意事项：
                    <ul>
                        <li>请按照模板里的格式填写专利信息，否则可能会导入信息失败哦；</li>
                ...
                excel.importExcel(files, {
                    ...
                    layer.open({
                        ...
                        ,yes: function(index, layero){
                            $.ajax({
                                type: "POST",
                                url: "${pageContext.request.contextPath }/patentUpload.action",
...
<script>
    ...
    function exportDataTest() {
        layui.use(['excel'], function() {
            ...
            var data = [
                ["申请时间", '授权时间', '专利号', '专利类型', '专利级别', '专利名称',
                    "发明人详情"
                ],
                ["2019-07-31", "2019-09-01", 'ZL201921607578.9',
                    '实用新型', '国际专利', "一种基于人机工程学数据的人体感知特性测试方法",
                    '王宇03|中国地质大学（武汉）|是|00003;BALLARD, WW|null|否|null;'
                ]
            ];
            excel.exportExcel({
                sheet1: data
