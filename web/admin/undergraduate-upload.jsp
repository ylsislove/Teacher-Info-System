                    ...
                    excel.importExcel(files, {
                        ...
                        layer.open({
                            ...
                            ,yes: function(index, layero){
                                $.ajax({
                                    type: "POST",
                                    url: "${pageContext.request.contextPath }/undergraduateUpload.action",
    ...
    <script>
        ...
        function exportDataTest() {
            layui.use(['excel'], function() {
                ...
                var data = [
                    ["教师", '工号', '时间', '学生姓名'
                        <c:if test="${param.type == 1}">,'实习周数'</c:if>
                    ],
                    ["张三", "00001", '2019', '小明, 小红, 小黄, 小白, 小黑'
                        <c:if test="${param.type == 1}">,'32'</c:if>
                    ]
                ];
                excel.exportExcel({
                    sheet1: data
